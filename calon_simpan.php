...
//$hportu3=trim($_REQUEST['namauser']);
...
//user
$namauser=trim($_REQUEST['namauser']);
...
{	
	$sql = "UPDATE jbsakad.calonsiswa
			   SET nama='$nama', panggilan='$panggilan', idproses=$proses, idkelompok=$kelompok, suku=$suku,
				   ...
				   hportu='$hportu', info1='$hportu2', info2='$namauser', emailayah='$emailayah', emailibu='$emailibu',
...
else
{
	...
	$sql = "INSERT INTO jbsakad.calonsiswa
			   SET nopendaftaran='$no', nama='$nama', panggilan='$panggilan', tahunmasuk='$tahunmasuk', idproses='$proses',
				   ...
				   info1='$hportu2', info2='$namauser', emailayah='$emailayah', emailibu='$emailibu', alamatsurat='$alamatsurat',
