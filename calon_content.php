...
<?	$sql_tot = "SELECT nopendaftaran,nama,asalsekolah,tmplahir,DAY(tgllahir),MONTH(tgllahir),YEAR(tgllahir),". 
		   "c.aktif,c.replid,c.info2 FROM calonsiswa c, kelompokcalonsiswa k, prosespenerimaansiswa p ".
	...
	$sql = "SELECT nopendaftaran,nama,c.sum1,c.info2,c.ujian1,c.ujian2,c.ujian3,c.ujian4,c.ujian5,c.ujian6,c.ujian7,c.ujian8,c.ujian9,c.ujian10,". 
...
<?		} ?>	
	...
	<tr class="header" height="30" align="center">		
        ...
        <td width="100" onMouseOver="background='../style/formbg2agreen.gif';height=30;" onMouseOut="background='../style/formbg2.gif';height=30;" background="../style/formbg2.gif" onClick="change_urut('info2','<?=$urutan?>')" style="cursor:pointer;">Info#2 <?=change_urut('info2',$urut,$urutan)?>Operator</td>
...
<?		$sqlset = "SELECT COUNT(replid) FROM settingpsb WHERE idproses = $proses";
		...
		if ($ndata > 0)
		{
			...
			//pengganti user saya ambil sumbangan2 menjadi user operator
			$kdsum2 = $rowset['info2']; //$nmsum2 = $rowset['nmsum2'];
    ...
    <tr class="header" height="30" align="center">		
        ...
        <td onMouseOver="background='../style/formbg2agreen.gif';height=30;" onMouseOut="background='../style/formbg2.gif';height=30;" background="../style/formbg2.gif" onClick="change_urut('sum2','<?=$urutan?>')" style="cursor:pointer;"><?=$info2?> <?=change_urut('info2',$urut,$urutan)?></td>
...
<? 		if ($page==0)
		...
		<tr>        			
            ...
            <td height="25" align="right"><?=$row["info2"]?></td>
			...
			<td height="25" align="center"><?=$row["info2"]?></td>
            <td height="25" align="center">
