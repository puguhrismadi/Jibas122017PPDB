	...
	<br />
 	...
 	<tr>
		...
		<tr>
  		...
  		<!--  untuk tambahan hidden user dan tampil -->
  		  <tr><td valign="top">Operator</td>
			<td colspan="2"><input type="hidden" name="namauser" value="<?php echo $_SESSION['namasimaka'] ?>" /><input type="text" size="30" name="namausertampil" disabled value="<?php echo $_SESSION['namasimaka'] ?>" /> </td></tr>
		</table>    
